    <section class="secondary-block">
        ...
        <div class="container">
            ...
            <h2 style="color: black !important">Have a look at some of our workmanship examples HERE.</h2>
    ...
    <div class="intro-block intro-block--secondary">

    <div class="container">

        <div class="row flex">

            <div class="intro-block__description cell" data-animate-css="fadeIn" data-animate-css-delay="100ms">
            ...
            <div class="intro-block__media cell" data-animate-css="fadeIn" data-animate-css-delay="200ms">

                <figure class="">

                    <img src="assets/images/samples/floorplanning.jpg" alt="Alt text">
